        ...
        <div className='pdf-modal-overlay' onClick={onClose}>
            <div className='pdf-modal' onClick={e => e.stopPropagation()}>
                <div className='pdf-modal__header'>
                    <span className='pdf-modal__title'>Resume Preview</span>
                    <div className='pdf-modal__actions'>
                        <button className='pdf-modal__download-btn' onClick={handleDownload}>
                        ...
                        <button className='pdf-modal__close-btn' onClick={onClose} aria-label="Close preview">
...
const Interview = () => {
    ...
    const { report, getReportById, loading, error, getResumePdf, pdfBlobUrl, pdfFilename, clearPdf } = useInterview()
    ...
    if (error) {
        return (
            <main className='loading-screen'>
                <h1 style={{ color: '#f87171' }}>Failed to load report</h1>
                <p style={{ color: '#888', marginTop: '0.5rem' }}>{error}</p>
                <button className='button primary-button' style={{ marginTop: '1.5rem' }} onClick={() => navigate('/')}>
                    Go Home
                </button>
            </main>
        )
